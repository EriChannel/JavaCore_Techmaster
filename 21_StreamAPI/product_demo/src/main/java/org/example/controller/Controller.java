...
public class Controller {
        ...
        while (true){
            ...
            switch (option){
                ...
                case 6:
                    ...
                    productService.sortProductByPriceIncrease();
                    break;
                case 7:
                    System.out.println("-----Danh sách sản phẩm theo giá giảm dần-----");
                    productService.sortProductByPriceDecrease();
                    break;
                case 8:
                    findProductsByBrand();
                    break;
    ...
    private void findProductsByBrand() {
        Set<String> listBrand = productService.getAllBrands();
        listBrand.stream().sorted().forEach(System.out::println);
